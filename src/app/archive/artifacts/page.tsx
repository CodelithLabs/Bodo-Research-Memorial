...
import { Search, ArrowLeft, Calendar, MapPin, Eye, Map } from 'lucide-react';
...
export default function ArchiveArtifactsPage() {
    ...
    useEffect(() => {
        ...
        const artifacts = archiveItems.filter(item => item.type === 'artifact');
        setItems(artifacts);
    }, []);
                ...
                <div className="max-w-7xl mx-auto px-4 py-8">
                    ...
                    <div className="flex items-center gap-4 mb-2">
                        <div className="p-3 bg-heritage/10 rounded-lg">
                            <Map className="w-8 h-8 text-heritage" />
                        </div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-lg">
                        Traditional Bodo cultural artifacts — including the six GI-tagged musical instruments (Kham, Sifung, Serja,
                        Thorkha, Gongona, Jotha), the GI-tagged Dokhona, and the ceremonial Aronai scarf.
                    </p>
            ...
            <div className="max-w-7xl mx-auto px-4 py-6">
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                    <p className="text-green-800 text-sm">
                        <strong>Note:</strong> 21 Bodo traditional products have been granted Geographical Indication tags
                        by the Government of India in 2024, formally recognizing them as unique cultural products of the Bodo community.
                    </p>
                </div>
                            ...
                            >
                                <div className="p-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="bg-parrot/20 text-heritage text-xs px-2 py-0.5 rounded-full">
                                            Artifact
                                        </span>
                                        {item.tags.some(tag => tag.toLowerCase().includes('gi tag')) && (
