...
import { Search, ArrowLeft, Calendar, MapPin, Eye, FileText } from 'lucide-react';
...
export default function ArchiveDocumentsPage() {
    ...
    useEffect(() => {
        ...
        const documents = archiveItems.filter(item =>
            item.type === 'document' || item.type === 'map'
        );
        setItems(documents);
    }, []);
                ...
                <div className="max-w-7xl mx-auto px-4 py-8">
                    ...
                    <div className="flex items-center gap-4 mb-2">
                        <div className="p-3 bg-heritage/10 rounded-lg">
                            <FileText className="w-8 h-8 text-heritage" />
                        </div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-lg">
                        Primary historical documents in Bodo history — from the 1929 Simon Commission memorandum and Grierson&apos;s 1903 Linguistic Survey to the 1993 and 2003 Bodo Accords.
                    </p>
