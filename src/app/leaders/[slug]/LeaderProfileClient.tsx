    ...
    <div className="min-h-screen bg-background font-body">
      ...
      <section className="bg-primary pt-24 pb-12 relative overflow-hidden">
        ...
        <div className="container-institutional relative z-10">
          <Link
            href="/leaders"
            className="inline-flex items-center text-secondary/80 hover:text-secondary text-xs font-bold uppercase tracking-[0.2em] mb-12 transition-colors"
          >
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start lg:items-center">
            ...
            <div className="flex-1">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 bg-secondary text-primary px-4 py-2 text-[10px] font-bold uppercase tracking-[0.3em] shadow-lg shadow-secondary/20 hover:bg-secondary/90 transition-colors"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {relatedLeaders.map((related) => (
                <Link
                  ...
                  className="group block bg-white border border-divider overflow-hidden hover:border-secondary transition-colors"
                >
                  ...
                  <div className="p-6">
                    ...
                    <h4 className="text-primary font-bold text-lg mt-2 mb-2 group-hover:text-secondary transition-colors">
                      {related.name}
                    </h4>
                    <p className="text-text-muted text-sm">{related.title}</p>
                  </div>
                </Link>
              ))}
            </div>
      ...
      <CitationModal isOpen={isCitationOpen} onClose={() => setIsCitationOpen(false)} data={citationData} />
    </div>
  );
}
